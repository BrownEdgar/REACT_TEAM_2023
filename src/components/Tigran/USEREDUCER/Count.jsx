  ...
  return (
    <div key={Date.now()} className="Container">
            ...
            <div className="Container__ChangeButtonsValues">
                <button className="Container__Btn" onClick={() => dispatch({type: "increment"})}>PlusOne</button>
                <button className="Container__Btn" onClick={() => dispatch({type: "reset"})}>Reset</button>
                <button className="Container__Btn" onClick={() => dispatch({type: "decrement"})}>MinusOne</button>
